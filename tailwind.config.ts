...
module.exports = {
  ...
  theme: {
    ...
    "color": {
      ...
      "light": "text-gray-900 bg-white border border-gray-300 enabled:hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:enabled:hover:bg-gray-700 dark:enabled:hover:border-gray-700 dark:focus:ring-gray-700",
      ...
      "cyan": "text-blue-900 bg-white border border-blue-300 enabled:hover:bg-blue-100 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:text-white dark:border-blue-600 dark:enabled:hover:bg-blue-700 dark:enabled:hover:border-blue-700 dark:focus:ring-blue-700",
    ...
    "gradient": {
      "blue": "text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 enabled:hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800",
      ...
      "info": "text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 enabled:hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 ",
    ...
    "gradientDuoTone": {
      "blueToBlue": "text-white bg-gradient-to-r from-blue-500 to-blue-500 enabled:hover:bg-gradient-to-bl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800",
      "greenToBlue": "text-white bg-gradient-to-br from-green-400 to-blue-600 enabled:hover:bg-gradient-to-bl focus:ring-4 focus:ring-green-200 dark:focus:ring-green-800",
      ...
      "purpleToBlue": "text-white bg-gradient-to-br from-purple-600 to-blue-500 enabled:hover:bg-gradient-to-bl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800",
