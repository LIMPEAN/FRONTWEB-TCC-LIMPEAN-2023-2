...
export function HomeComponent() {
  return (
    <>
      <div id="home" className="bg-blue-600 mt-24 p-6 lg:mt-0 h-full flex flex-col  lg:flex-row items-center justify-center">
        <div className="flex flex-col lg:w-2/5 gap-6 w-full">
          ...
          <span className="text-slate-300 font-thin text-justify  w-full">  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&rsquo;s standard dummy text ever since the 1500s
          </span>
