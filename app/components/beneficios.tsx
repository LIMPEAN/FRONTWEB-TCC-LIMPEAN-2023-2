...
export function Beneficios() {
  ...
  return (
    <div id="beneficios" className="flex flex-col h-screen bg-slate-100 p-6 gap-4">
      <h2 className="text-blue-600 font-medium text-center text-2xl">Garantimos os melhores benefícios para você!</h2>
