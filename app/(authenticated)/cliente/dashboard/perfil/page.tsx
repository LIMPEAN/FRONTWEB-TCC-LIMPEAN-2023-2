      ...
      >
        ...
        >
          ...
          {data?.endereco.map((adress: IEndereco) => {
            return (
              <form key={data?.name} onSubmit={handleSubmit} className='flex flex-col p-4 gap-4 items-start w-full text-gray-800  rounded-lg shadow dark:bg-gray-800 dark:text-white dark:border-gray-700 mb-4'>
