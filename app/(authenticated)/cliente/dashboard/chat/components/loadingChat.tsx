...
export default function ChatComponentLoading() {
  return (
    <>
      ...
      >
        ...
        <div className="bg-black-600 h-full p-2 flex flex-col gap-2 overflow-y-scroll">
        ...
        <form>
          ...
          <div className="flex items-center px-3 py-2  bg-gray-50 dark:bg-gray-700">
            ...
            <input type="text" id="chat" className="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></input>
            <button
              type="button" className="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600">
