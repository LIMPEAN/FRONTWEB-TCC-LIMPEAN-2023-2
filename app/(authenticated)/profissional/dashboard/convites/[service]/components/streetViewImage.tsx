...
export default function StreetViewImage({client}: ClientData) {
  ...
  useEffect(() => {
    const fetchData = () => {
      const apiUrl = `https://maps.googleapis.com/maps/api/geocode/json?address=${client.address.cep}+${client.address.state}+${client.address.city}&key=AIzaSyBAtBZmnQA0lanlxnItwvZ2Zsa-BNs2Q8I`;
