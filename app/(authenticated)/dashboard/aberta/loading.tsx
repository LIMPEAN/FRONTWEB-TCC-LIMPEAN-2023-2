          ...
          arr.map((_, index) => (
            <li key={index} className="flex w-fit justify-center items-center">
              <div role="status" className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
                <div className="flex items-center justify-center h-48 w-64 mb-4 bg-gray-300 rounded dark:bg-gray-700">
                ...
                <div className="flex items-center mt-4 space-x-3">
                  <div>
                    <div className="flex w-full gap-4">
                      <div className="h-8 bg-gray-200 rounded-sm dark:bg-gray-700 w-24 mb-2"></div>
                      <div className="w-32 h-8 bg-gray-200 rounded-sm dark:bg-gray-700"></div>
                    </div>
                  </div>
                </div>
