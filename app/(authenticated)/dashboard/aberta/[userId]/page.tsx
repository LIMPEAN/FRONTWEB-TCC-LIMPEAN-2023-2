    ...
    <div className="h-full flex flex-col p-2 bg-inherit">
      ...
      <div className="flex flex-col lg:flex-row h-full gap-4">
        <div className="flex flex-col lg:w-3/5 gap-4 lg:overflow-auto">
          <div className="flex flex-col 2xl:flex-row px-4 h-fit  py-8 gap-4 items-center  text-gray-800  rounded-lg shadow dark:bg-gray-800 dark:text-white dark:border-gray-700">
